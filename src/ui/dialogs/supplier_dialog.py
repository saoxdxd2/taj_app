...
class SupplierDialog(FormDialog):
    def __init__(self, supplier=None, parent=None):
        ...
        super().__init__(
            title="Edit Supplier" if supplier else "New Supplier",
    ...
    def setup_ui(self):
        ...
        self.company_name_input.setPlaceholderText("e.g. Clim Distribution SARL")
        ...
        self.phone_input.setPlaceholderText("e.g. 05 22 34 56 78")
        ...
        box = self.add_buttons(ok_text="Save Supplier")
